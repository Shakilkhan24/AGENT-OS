...
const KNOWN_SETTING_KEYS = [
  ...
  "attachmentCacheSize",
  "attachmentIdleMs",
  "attachmentRegistryReplayBufferBytes",
  "attachmentRegistryByteCreditsDefault",
  "attachmentRegistryOwnershipHandoverTimeoutMs",
  "promptAnchorEnabled",
  "promptAnchorsMaxPerTerminal",
  "promptAnchorStalenessMs",
  "promptAnchorLiterals",
  "workflowExecutorMaxFanout",
  "workflowExecutorDefaultStepTimeoutMs",
  "workflowExecutorWaitPollMs",
  "gracefulStopMs",
  "fileWatching",
  "shellMode",
  "telemetry",
